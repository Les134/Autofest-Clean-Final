  ...
  if(screen==="score"){
    return (
      <div style={scoreWrap}>
        ...
        {/* GENDER */}
        <div>
          <button disabled={!entryValid} onClick={()=>setGender("Male")} style={gender==="Male"?activeBtn:bigBtn}>Male</button>
          <button disabled={!entryValid} onClick={()=>setGender("Female")} style={gender==="Female"?activeBtn:bigBtn}>Female</button>
        </div>
